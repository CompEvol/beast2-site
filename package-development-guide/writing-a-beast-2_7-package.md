...
o Click on the <b>Arguments</b> tab and type &#8220;examples/testF84.xml&#8221; in the <b>Program arguments</b> field to specify that the <i>testF84.xml</i> file should be run when debugging
